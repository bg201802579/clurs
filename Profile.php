...
<div class="sidenav">
  ...
  <a href="Profile.php" class="active"><i class="fa fa-user-o" style="font-size:22px" align="center"></i><br> <br>Profile</a>
  ...
  <a href="index.php"><i class="fa fa-sign-out" style="font-size:24px"></i> <br><br> log out</a>
</div>
<div class="header">
  <p class="headtxt"><?php echo $_SESSION['fname'] ?>Profile</p>
</div>
...
<br><br>
  ...
  <h2>First name : </h2> <h3><?php echo $_SESSION['fname']; ?></h3>
